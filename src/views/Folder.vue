  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <div id="container" v-if="$route.params.id == 'Home'">
        <ion-card class="slide-in-left" v-if="login">
          <ion-card-header>
        ...
        <ion-card class="slide-in-left" v-if="formRegistro">
          <ion-card-header>
        ...
        <ion-card class="slide-in-left" v-if="formHealth">
          <ion-card-header>
        ...
        <ion-card v-if="status">
          ...
          <div class="jello-horizontal" v-if="btnChkStatus">
            <button
              class="btn btn-warning"
              @click="fnEvaluation(), (btnChkStatus = false)"
            >
              Chek Risk Status
            </button>
          </div>

          <div class="puff-in-center" v-if="!btnChkStatus">
            <h2>{{ userData[0].name + " " + userData[0].lastname }}</h2>
            <h6>
              Today Risk factor
              <img src="assets/img/velocimetro.gif" width="50" alt="" />
            </h6>
            <img
              src="assets/img/lvl1.png"
              alt=""
              v-if="stathq >= 0 && stathq < 3"
            />
            <img
              src="assets/img/lvl2.png"
              alt=""
              v-if="stathq >= 3 && stathq < 6"
            />
            <img
              src="assets/img/lvl3.png"
              alt=""
              v-if="stathq >= 6 && stathq < 9"
            />
            <img src="assets/img/lvl4.png" alt="" v-if="stathq >= 9" />
          </div>
...
/* ----------------------------------------------
 * Generated by Animista on 2021-10-3 2:26:54
...
/* ----------------------------------------------
 * Generated by Animista on 2021-10-3 2:35:32
 * Licensed under FreeBSD License.
 * See http://animista.net/license for more info. 
 * w: http://animista.net, t: @cssanimista
 * ---------------------------------------------- */
...
/* ----------------------------------------------
 * Generated by Animista on 2021-10-3 2:39:0
 * Licensed under FreeBSD License.
 * See http://animista.net/license for more info. 
 * w: http://animista.net, t: @cssanimista
 * ---------------------------------------------- */
